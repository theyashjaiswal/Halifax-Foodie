...
import RestaurantWordCloud from "./pages/restaurant/RestaurantWordCloud";

Amplify.configure({
  Auth: {
    identityPoolId: "us-east-1:4df7c38d-b678-43c9-b912-882473f68098",
    region: "us-east-1",
  },
  Interactions: {
    bots: {
  ...
  <Router>
    <main className="my-5 pt-3" style={{ minHeight: "80vh" }}>
      <Switch>
        ...
        <Route path="/customer/feedback" component={CustomerFeedback}></Route>
        <Route
        ...
        ></Route>
        <Route
          path="/restaurant/wordcloud"
          component={RestaurantWordCloud}
        ></Route>
        <Route path="/chat">
          <Chat />
        </Route>
        ...
        <Route path="/mfa" component={SecurityQuestions}></Route>
